import{a as e,r as t}from"./index-BYfdeBoQ.js";import{t as n}from"./button-BB89JIYu.js";import{t as r}from"./weather-model-BvNUa4wj.js";var i=`基于拆补法转盘奇门的时空权重模型及其在瓯海区天气旬候预测中的校准研究`,a=`# ${i}
...
`,o=e();function s(){return(0,o.jsxs)(`main`,{className:`min-h-dvh bg-bg text-fg`,children:[(0,o.jsx)(`header`,{className:`border-b border-border`,children:(0,o.jsxs)(`div`,{className:`mx-auto flex max-w-3xl flex-wrap items-center justify-between gap-3 px-4 py-4`,children:[(0,o.jsx)(t,{to:`/`,className:`text-xs text-muted hover:text-fg`,children:`返回起盘`}),(0,o.jsxs)(`div`,{className:`flex gap-2`,children:[(0,o.jsx)(n,{type:`button`,variant:`secondary`,size:`sm`,onClick:()=>{let e=new Blob([JSON.stringify(r,null,2)],{type:`application/json`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`ouhai-weather-2025-2026.json`,t.click()},children:`下载训练数据`}),(0,o.jsx)(n,{type:`button`,size:`sm`,onClick:()=>{let e=new Blob([a],{type:`text/markdown;charset=utf-8`}),t=document.createElement(`a`);t.href=URL.createObjectURL(e),t.download=`qimen-ouhai-weather-thesis.md`,t.click()},children:`下载论文`})]})]})}),(0,o.jsxs)(`article`,{className:`mx-auto max-w-3xl px-4 py-8`,children:[(0,o.jsx)(`p`,{className:`text-xs text-subtle`,children:`博士学位论文体例 · 学习研究文本`}),(0,o.jsx)(`h1`,{className:`mt-2 font-display text-2xl leading-snug text-fg`,children:i}),(0,o.jsxs)(`p`,{className:`mt-3 text-xs text-muted`,children:[r.place,` · `,r.start,` – `,r.end,` · `,r.n,` 日 ·`,` `,r.citation]}),(0,o.jsx)(`div`,{className:`thesis-body mt-8 text-sm leading-7 text-fg`,children:c(a)})]})]})}function c(e){let t=e.split(`
`),n=[],r=[],i=[],a=0,s=()=>{if(!r.length)return;let e=r.join(` `).trim();r=[],e&&n.push((0,o.jsx)(`p`,{children:e},a++))},c=()=>{i.length&&(n.push((0,o.jsx)(`ul`,{className:`my-3 list-disc space-y-1 pl-5 text-muted`,children:i.map((e,t)=>(0,o.jsx)(`li`,{children:e},t))},a++)),i=[])};for(let e of t){if(e.startsWith(`# `)){c(),s();continue}if(e.startsWith(`## `)){c(),s(),n.push((0,o.jsx)(`h2`,{className:`mt-8 font-display text-lg text-fg`,children:e.slice(3)},a++));continue}if(e.startsWith(`### `)){c(),s(),n.push((0,o.jsx)(`h3`,{className:`mt-5 font-display text-base text-fg`,children:e.slice(4)},a++));continue}if(e.startsWith(`- `)){s(),i.push(e.slice(2));continue}if(e.trim()===``||e.trim()===`---`){c(),s();continue}if(e.startsWith(`[`)||/^\[[0-9]+\]/.test(e)){c(),s(),n.push((0,o.jsx)(`p`,{className:`text-xs leading-6 text-muted`,children:e},a++));continue}r.push(e)}return c(),s(),n}export{s as component};