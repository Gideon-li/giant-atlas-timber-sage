...
import { r as toAuthEmail } from "./admin-ids-Dastpfcy.mjs";
import { t as Button } from "./button-Yi4zxPuq.mjs";
import { t as GROK_PROVIDERS } from "./server-CqRAn7m7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-8va4WQ4i.js
...
function Login() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		className: "grid min-h-dvh place-items-center bg-bg px-[max(1rem,env(safe-area-inset-left,0px))] py-10 pb-[max(2.5rem,env(safe-area-inset-bottom,0px))] text-fg",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "可用手机号或邮箱。指定管理员手机号登录后进入后台，下载论文与数据。"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "flex flex-col gap-1 text-xs text-muted",
							children: ["手机号或邮箱", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								required: true,
